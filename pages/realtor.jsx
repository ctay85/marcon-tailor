		...
		<>
			...
			<main className="page__realtor">
				<div className="wrap--reg">
					<div className="section-intro">
						...
						<aside>
							<p className="text--display">
								Here you can find Tailor brand assets and sales program information that can be used for the
								promotion of this boutique{' '}
								<strong>
									twenty-seven storey tower comprised of 193 homes nestled in the heart of Brentwood.
								</strong>
							</p>
							<p>
								<em>
									Please be sure to review the Disclaimer for legal requirements pertaining to the use of all
									marketing renderings and materials provided.
								</em>
							</p>
						</aside>
					</div>
					...
					<div className="marketing">
						<div className="left">
							...
							<p>
								...
								<a href={`${process.env.BASE_PATH}/rel/Tailor_by_Marcon_Preview_Package.pdf`} target="_blank">
									EN
								</a>{' '}
								|{' '}
								<a href={`${process.env.BASE_PATH}/rel/Tailor_by_Marcon_Preview_Package-cn.pdf`} target="_blank">
									CN
								</a>
								<br />
								Logo &mdash;{' '}
					...
					<p>
						You can schedule a private appointment to the Tailor Sales Centre located at 2421 Alpha Avenue in
						Burnaby. Please connect with our Tailor Sales Team to schedule a private tour: Call{' '}
					...
					<p>
						<small>*Please note, foreign purchasers will be required to provide a total deposit of 25%</small>
					</p>
          ...
          */}
						...
						{unitData.map((unit, i) => (
							<div className="grid__item" key={i}>
								<div>
									...
									{unit.images ? <img src={unit.images[0].file} /> : <img src={unit.image} />}
								</div>
								...
								<div>
									...
									<a className="btn btn--solid" target="_blank" download href={unit.pdf}>
										Download PDF
									</a>
								</div>
							</div>
					...
					<div className="book-btn">
						<a href="https://rennie.as.me/tailor" className="btn btn--solid btn__book-appointment" target="_blank">
					...
					<p>
						...
						finishes, features, incentives and dimensions, without prior notice. Renderings and any depicted views
						are artistic concepts only. Square footages are approximate and have been calculated from architectural
						drawings. Actual final dimensions following completion of construction may vary from those set out
						herein. E.&O.E. Marcon Alpha (GP) Ltd. * Pricing, promotions and incentives are all subject to change
						without prior notice. Please see sales representative for details.
					</p>
				</div>
			</main>
		</>
