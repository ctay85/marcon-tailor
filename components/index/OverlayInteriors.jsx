  ...
  return (
    <Overlay {...props}>
      <OverlayGallery images={[
        ...
        { file : `${process.env.BASE_PATH}/img/index/interiors/Tailor-Web-23.jpg`, caption : '2 Bedroom', blurb : 'Living' },
        ...
        { file : `${process.env.BASE_PATH}/img/index/interiors/Tailor-Web-17.jpg`, caption : '1 Bedroom', blurb : 'Kitchen' },
        { file : `${process.env.BASE_PATH}/img/index/interiors/Tailor-Web-14.jpg`, caption : '1 Bedroom', blurb : 'Bathroom' },
        ...
        { file : `${process.env.BASE_PATH}/img/index/interiors/Tailor-Web-25.jpg`, caption : '2 Bedroom', blurb : 'Bedroom' },
      ]} />
    </Overlay>
  )
}
