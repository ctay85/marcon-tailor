        ...
        <Accordion>
          <AccordionItem title="Homes">
            <ul>
              ...
              <li>High efficiency heating and air conditioning system for year‐round comfort</li>
              ...
              <li>Smart glass LowE2 panoramic windows welcome an abundance of natural light and fresh air</li>
              <li>Built in USB charging connection in kitchen and bedrooms</li>
              <li>Spacious master bedrooms for ultimate relaxation (room for king beds in most)</li>
              <li>Wide‐plank laminate hardwood flooring either in Dahlia or Noah</li>
          ...
          <AccordionItem title="Kitchens">
            <ul>
              <li>Panasonic stainless steel microwave oven with trim kit above and below</li>
              <li>Cabinetry doors complete with soft close hardware</li>
              <li>Lazy Susan corner storage unit for added convenience and storage (select homes)</li>
              ...
              <li>Kohler pull‐down single lever faucet with vegetable sprayer in polished chrome</li>
              <li>Under‐sink pull‐out recycling bins</li>
              <li>Recessed pot lighting accompanied with LED under‐cabinet puck lighting</li>
            </ul>

            <p className="list-title"><strong>For one bedroom homes, premium stainless‐steel appliances include:</strong></p>
            <ul>
            ...
            <p className="list-title"><strong>For two bedroom, penthouse and townhome plans, premium stainless steel appliances include:</strong></p>
            <ul>
          ...
          <AccordionItem title="Ensuite and Main Bath">
            <ul>
              <li>Floating vanity with under‐cabinet motion sensor lighting complete with soft close hardware</li>
              ...
              <li>Mirrored medicine cabinets in ensuite for your day‐to‐day essentials</li>
              <li>12" x 24" matte porcelain floor tile and back wall of shower and tub apron</li>
              <li>Ceramic wall tile</li>
              <li>Built‐in ledge in showers</li>
              <li>Kohler hand shower system in polished chrome with conveniently placed shower control valve for easy access</li>
              ...
              <li>Bathroom accessories (towel bar, tissue holder) in polished chrome</li>
            </ul>
          </AccordionItem>
        </Accordion>
      </OverlayContent>
