    ...
    >
      ...
      >
        <BgImage
          src={
            isMobile
              ? `${process.env.BASE_PATH}/img/index/tailor-int-02-1080x1920.png`
              : `${process.env.BASE_PATH}/img/index/image3.jpg`
          }
        />
      </motion.div>
      ...
      <article>
        <motion.span
          ...
          dangerouslySetInnerHTML={{ __html: locale.index.interiors.title }}
        ></motion.span>
        ...
        >
          {locale.index.interiors.description}
        </motion.p>
      </article>

      <div
        className="mobile-tap-indicator"
        onClick={() => setActiveOverlayKey(INDEX_OVERLAY_KEY_INTERIORS)}
      >
        <span>More</span>
      </div>
