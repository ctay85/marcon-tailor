...
const Register = ({ reversed = false }) => {
	...
	const validateFormFields = () => {
		...
		const textInputs = [
			...form.current.querySelectorAll('.input-group input[type="text"], .input-group input[type="phone"]')
		]
				...
				<form data-reversed={reversed} ref={form} method="post" validate="true">
					...
					<div className="checkbox-group">
						<div>
							...
							<label htmlFor="futureOptInYes" className="small-italic">
								{locale.overlays.enquire.form.optin}
							</label>
						</div>
					</div>
					...
					<button className="btn__register" type="submit" onClick={onSubmit}>
						{locale.overlays.enquire.form.submit}
					</button>
