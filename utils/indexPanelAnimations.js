...
export default {
  container : {
    ...
    exit : { opacity : 0, transition : { duration : INDEX_PANEL_TRANSITION_DURATION }}
  },

  panelName : {
    initial : { opacity : 0, y : 50 },
    enter : { opacity : 1, y : 0, transition : { duration : INDEX_PANEL_TRANSITION_DURATION, delay : 0.8 }},
    exit : { opacity : 0, y : -50, transition : { duration : INDEX_PANEL_TRANSITION_DURATION }}
  },

  panelTagline : {
    initial : { opacity : 0, y : 50 },
    enter : { opacity : 1, y : 0, transition : { duration : INDEX_PANEL_TRANSITION_DURATION, delay : 0.7 }},
    exit : { opacity : 0, y : -50, transition : { duration : INDEX_PANEL_TRANSITION_DURATION, delay : 0.1 }}
  },

  panelDescription : {
    initial : { opacity : 0, y : 50 },
    enter : { opacity : 1, y : 0, transition : { duration : INDEX_PANEL_TRANSITION_DURATION, delay : 0.6 }},
    exit : { opacity : 0, y : -50, transition : { duration : INDEX_PANEL_TRANSITION_DURATION, delay : 0.2 }}
  },

  btnMore : {
    initial : { opacity : 0, y : 50 },
    enter : { opacity : 1, y : 0, transition : { duration : INDEX_PANEL_TRANSITION_DURATION, delay : 0.5 }},
    exit : { opacity : 0, y : -50, transition : { duration : INDEX_PANEL_TRANSITION_DURATION, delay : 0.3 }}
  },
